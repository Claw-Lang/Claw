...
print(abs(-5.0 as int)) # ints are int64 by default in Claw, they're int32 in C

# or you can just let Claw convert between "compatible" types such as numbers
print(abs(-5.0))

# Named parameters and defaults
def optional_params(x: int, y: int32 = 5, z: double = 9) -> int
	# Claw takes care of casting the return type between "compatible" types
	return x + z
